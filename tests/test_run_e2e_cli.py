...
def test_config_by_name_maps_the_three_presets():
    ...
    assert serialize_config(config_by_name("governed_rrf")) == \
        serialize_config(RetrievalConfig.default())
...
def test_report_path_includes_config_name(tmp_path):
    ...
    other = report_path("governed_rrf", "20260810_161500", report_dir=tmp_path)
